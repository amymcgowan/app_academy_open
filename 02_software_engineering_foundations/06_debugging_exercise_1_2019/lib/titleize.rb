...
# switched block variables - line 15 (saw they were switched
# whlie displaying variables in byebug)
# moved little_words from outside the method to inside. (could
# not find local variable)