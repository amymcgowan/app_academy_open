...
# line 12 - I can just exactly what I want the element to be (originally i put
# ele = hash[ele]).  I also don't need to call the array at the end, because
# .map! automatically evaluates to an array.  Other than those simplifying 
# details... I got it on my own!!

# This was practice in modifying an array without making a new one/changing
# its memory location.
