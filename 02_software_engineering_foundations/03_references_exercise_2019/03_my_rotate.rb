...
# I pretty much had this one on my own, but I was getting hung up with how to 
# handle the neg amount...I even had the conditionals set up.  In the 
# walkthrough I saw to just neg the neg amt...and that fixed it!
